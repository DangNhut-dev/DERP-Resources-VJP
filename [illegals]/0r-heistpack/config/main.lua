...
Config.heistMenu = {
    ...
    openWithCommand = {
        enabled = false, -- Set to true to enable command-based menu opening.
        command = "heistmenu",
    },
    -- Keybind to open the heist menu.
    openWithKey = {
        enabled = false, -- Set to true to enable keybind-based menu opening.
        key = "F10",
    },
...
Config.policeOptions = {
    ...
    requiredOnDuty = false,     -- If true, only counts police that are on duty.
...
Config.jobClothingOptions = {
    enabled = false, -- Enable or disable job-specific clothing.
...
Config.modernTextUI = {
    enabled = false, -- Enable or disable modern or custom textui.
}
