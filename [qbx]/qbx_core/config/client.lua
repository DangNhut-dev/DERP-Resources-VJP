return {
    ...
    discord = {
        ...
        appId = '1493378130985877625', -- This is the Application ID (Replace this with you own)
        ...
        largeIcon = { -- To set this up, visit https://forum.cfx.re/t/how-to-updated-discord-rich-presence-custom-image/157686
            ...
            text = 'DE:RP', -- Here you can add hover text for the 'large' icon.
        },

        smallIcon = {
            icon = 'DE:RP', -- Here you will have to put the image name for the 'small' icon.
            text = 'Dominion Entropy : Roleplay', -- Here you can add hover text for the 'small' icon.
        },
