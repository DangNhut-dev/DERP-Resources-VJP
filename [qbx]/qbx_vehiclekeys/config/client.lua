...
return {
    ...
    getKeysWhenEngineIsRunning = false, -- when enabled, gives keys to a player who doesn't have them if they enter the driver seat when the engine is running
    ...
    sharedKeys = { -- Share keys amongst employees. Employees can lock/unlock any job-listed vehicle
        police = { -- Job name
            ...
            classes = {18},
            vehicles = {
                [`police`] = false,  -- Vehicle model
                [`police2`] = false, -- Vehicle model
            }
        },
        ambulance = {
            enableAutolock = true,
