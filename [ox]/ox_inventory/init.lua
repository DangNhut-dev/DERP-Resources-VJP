...
shared = {
    ...
    playerslots = GetConvarInt('inventory:slots', 15),
...
shared.dropslots = GetConvarInt('inventory:dropslots', 50)
shared.dropweight = GetConvarInt('inventory:dropweight', 500000)
...
if IsDuplicityVersion() then
    ...
    client = {
        ...
        clothesImagepath = GetConvar('inventory:clothesImagepath', 'https://gta5root.top/fivem/items101'),
