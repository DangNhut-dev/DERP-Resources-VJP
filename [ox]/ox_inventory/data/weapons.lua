return {
	Weapons = {
		...
		['WEAPON_KATANABLACKGOLD'] 			= { label = 'Katana Vàng Đen', 		    weight = 1000,	durability = 0.1,	},      		
	...
	Components = {
		...
		--custom component
		['at_clip_extended_pistol2'] = {
			label = 'Băng Đạn Mở Rộng Súng Lục',
			type = 'magazine',
			weight = 280,
			client = {
				image = 'at_clip_extended1.png',
				component = {
					`COMPONENT_CERAMICPISTOL_CLIP_02`,
					`COMPONENT_DAGGERP80_CLIP_02`,
					`COMPONENT_GLOCK19PATRIOT_CLIP_02`,
					`COMPONENT_GLOCK19X_CLIP_02`,
					`COMPONENT_MAC10_CLIP_02`,
					`COMPONENT_GLOCK17CUSTOM_CLIP_02`,
					`COMPONENT_G2CTX_CLIP_02`,
					`COMPONENT_SIGM17_CLIP_02`,
					`COMPONENT_GLOCK26S_CLIP_02`,
					`COMPONENT_GLOCK40S_CLIP_02`,
					`COMPONENT_GLOCK19SWITCH_CLIP_02`,
					`COMPONENT_GLOCK18C_CLIP_02`,
					`COMPONENT_PFS9P80_CLIP_02`,
					`COMPONENT_GLOCK45_CLIP_02`,
					`COMPONENT_FN509_CLIP_02`,
					`COMPONENT_GLOCK19TAN_CLIP_02`,
					`COMPONENT_G26_CLIP_02`,
		...
		['at_clip_drum_pistol'] = {
			label = 'Băng Đạn Ổ Quay Súng Lục',
			type = 'magazine',
			weight = 280,
			client = {
				image = 'at_clip_drummag.png',
				component = {
					`COMPONENT_GLOCK26S_CLIP_03`,
		...
		['at_clip_extended_riflemag'] = {
			label = 'Băng Đạn Mở Rộng Súng Trường',
			type = 'magazine',
			weight = 280,
			client = {
				image = 'at_clip_extendedmag.png',
				component = {
					`COMPONENT_AR15_CLIP_02`,
					`COMPONENT_AR15PDW_CLIP_02`,
					`COMPONENT_LONGARP_CLIP_02`,
					`COMPONENT_AR15FULL_CLIP_02`,
					`COMPONENT_AR15FULL_PURPLE_CLIP_02`,
					`COMPONENT_AR15FULL_WHITE_CLIP_02`,
					`COMPONENT_AR15PRINTED_CLIP_02`,
					`COMPONENT_AR15SHELLCATCHER_CLIP_02`,
					`COMPONENT_AR15PHANTOM_CLIP_02`,
					`COMPONENT_DRACOREDGRIP_CLIP_02`,
					`COMPONENT_DRACOPISTOL_CLIP_02`,
					`COMPONENT_DRACOCA_CLIP_02`,
					`COMPONENT_DRACOMICRO_CLIP_02`,
					`COMPONENT_DRACOCUSTOM_CLIP_02`,
					`COMPONENT_AK74_CLIP_01`,
				},
				usetime = 2500
			}
		},
		...
		['at_clip_drum_ar'] = {
			label = 'Băng Đạn Ổ Quay Súng Trường',
			type = 'magazine',
			weight = 280,
			client = {
				image = 'at_clip_drumar.png',
				component = {
					`COMPONENT_AR15_CLIP_03`,
					`COMPONENT_LONGARP_CLIP_03`,
					`COMPONENT_AR15FULL_CLIP_03`,
					`COMPONENT_AR15FULL_PURPLE_CLIP_03`,
					`COMPONENT_AR15FULL_WHITE_CLIP_03`,
					`COMPONENT_AR15PRINTED_CLIP_03`,
					`COMPONENT_AR15SHELLCATCHER_CLIP_03`,
					`COMPONENT_AR15PHANTOM_CLIP_03`,
					`COMPONENT_AR15PDW_CLIP_03`,
				},
				usetime = 2500
			}
		},
