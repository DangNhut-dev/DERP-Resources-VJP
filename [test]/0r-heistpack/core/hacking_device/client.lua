...
function HackingDeviceClientClass:_createDui()
    ...
    print("^3[HackingDevice] DUI URL: " .. self._duiConfig.url .. "^7")
    print("^3[HackingDevice] duiObject: " .. tostring(self._state.duiObject) .. "^7")
    print("^3[HackingDevice] IsDuiAvailable: " .. tostring(IsDuiAvailable(self._state.duiObject)) .. "^7")
...
function HackingDeviceClientClass:show()
    if self._state.active then
        print("^1[HackingDevice] Already active^7")
        return false
    end

    if not self:_hasRequiredWeapon() then
        print("^1[HackingDevice] No required weapon^7")
        Utils.notify(locale("hacking_device.weapon_required"), "error", 3000)
        return false
    end

    print("^2[HackingDevice] Passed weapon check, creating DUI...^7")
