...
-- Phone spawn and model settings
...
-- Password change permissions for apps
...
-- Account deletion permissions for apps
...
-- Currency and transfer settings
...
-- Version check
PerformHttpRequest("https://loaf-scripts.com/versions/", function(statusCode, response, headers)
    if response then
        print(response)
    end
