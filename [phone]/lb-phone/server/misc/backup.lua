...
-- Callback to create a backup for a phone number
...
BaseCallback("backup:applyBackup", function(source, currentPhoneNumber, backupPhoneNumber)
    ...
    -- Get phone settings from both phones
    ...
    -- Find backup phone data and current phone data
    ...
    -- Parse backup phone settings
    backupPhone.settings = json.decode(currentPhone.settings)
    
    -- Handle security settings - disable if no PIN/Face ID available
    ...
    -- Copy contacts from backup to current phone (avoid duplicates)
    MySQL.update.await([[
    ...
    -- Copy map locations from backup to current phone (avoid duplicates)
    MySQL.update.await([[
...
-- Callback to get all backups for a user
