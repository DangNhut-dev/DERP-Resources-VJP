-- DarkChat App for LB Phone
-- Handles anonymous chat channels and messaging

-- Register NUI callback for DarkChat actions
...
-- Handle new message notifications from server
...
-- Handle channel updates from server
