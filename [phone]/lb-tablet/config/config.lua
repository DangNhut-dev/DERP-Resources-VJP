...
Config.DatabaseChecker.Enabled = false -- if true, the tablet will check the database for any issues and fix them if possible
...
Config.BaseDispatch.RequireWitness = false -- require a witness (NPC) to trigger dispatch?
