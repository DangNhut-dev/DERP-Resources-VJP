Config = {
    ...
    planksPerLog = 5,
    axePrice     = 350,
    treeCooldown = 600000, -- 5 phút (ms)

    itemWeights = {
        log         = 2000,  -- 2kg
        cleanlog    = 1500,  -- 1.5kg
        rawplank    = 1000,  -- 1kg
        sandedplank = 800,   -- 800g
        finishwood  = 500,   -- 500g
    },

    itemLabels = {
        log         = 'Khúc gỗ',
        cleanlog    = 'Khúc gỗ sạch',
        rawplank    = 'Ván gỗ thô',
        sandedplank = 'Ván gỗ đã chà nhám',
        finishwood  = 'Gỗ thành phẩm',
        axe         = 'Rìu',
    },
    ...
    getCleaned = vector3(-570.11, 5330.40, 70.10),
    getPlanks  = vector3(-571.24, 5317.82, 70.18),
    sand       = vector3(-571.24, 5317.82, 70.18),
    finish     = vector3(-593.91, 5329.75, 70.30),
