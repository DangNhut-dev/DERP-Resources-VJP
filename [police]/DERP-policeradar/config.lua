return {
    ...
    Keybinds = { -- You can set these as nil if you don't want it to be something you open with a keybind.
        ToggleRadar = "F4",         -- Toggle radar on/off
        Interact = "F7",                -- Interact with radar UI
        SaveReading = "J",              -- Save current reading
        LockRadar = nil,               -- Lock/unlock all (speed + plates)
        LockSpeed = nil,                  -- Lock/unlock speed only
        LockPlate = nil,                  -- Lock/unlock plates only
        ToggleLog = nil,                -- Toggle log panel
        ToggleBolo = nil,               -- Toggle BOLO list
        ToggleKeybinds = nil,           -- Toggle keybinds display
