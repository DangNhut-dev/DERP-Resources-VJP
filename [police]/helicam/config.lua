...
Config.TimeFormat = 1 -- 0 = ZULU (UTC), 1 = In Game Time, 2 = OS TIME (Local Time)
...
Config.Localisation = {
    -- Notifications
    Notification = {
        JobNotWhitelisted = "Bạn không có công việc cần thiết!",
        JobGrade = "Điểm Rank việc của bạn thấp!",
        NoCameraHeli = "Chiếc trực thăng này không có camera!",
        NoCameraPlane = "Máy bay này không có camera!",
        IsPilot = "Bạn không thể sử dụng camera khi bạn là phi công!",
        NotInRear = "Bạn cần phải ở phía sau trực thăng để sử dụng camera!",
        CameraInUse = "Người khác đã sử dụng camera!",
        SpotlightInUse = "Người khác đã sử dụng đèn pha!",
        NoSpotlight = "Chiếc trực thăng này không có đèn pha!",
        SpotlightGlobalLimit = "Đã đạt đến giới hạn tiêu điểm!",
        CannotRappelFromHeli = "Máy bay trực thăng này không hỗ trợ leo dây!",
        CannotRappelFromSeat = "Bạn không thể leo dây xuống từ chỗ ngồi này!",
        ToHighToRappel = "Chiếc trực thăng phải bay lên cao để đu dây!",
        ConfirmRappel = "Bạn có chắc chắn muốn leo xuống không? (Nhấn lần nữa để xác nhận)",
        Rappeling = "Đu dây..!"
    },
    -- Blip Names
    Blip = {
    ...
    KeyMapping = {
        ToggleCam = "<FONT FACE='BARLOW'>Helicam - Sử dụng Camera</FONT>",
        AttemptLock = "<FONT FACE='BARLOW'>Helicam - Khóa mục tiêu</FONT>",
        CycleVision = "<FONT FACE='BARLOW'>Helicam - Đổi tầm nhìn</FONT>",
        ToggleMarker = "<FONT FACE='BARLOW'>Helicam - Thêm/Xóa Ping MAP</FONT>",
        Rappel = "<FONT FACE='BARLOW'>Helicam - Thả dây từ trực thăng</FONT>",
        Spotlight = "<FONT FACE='BARLOW'>Helicam - Bật đèn pha</FONT>",
        SpotlightBrightness = "<FONT FACE='BARLOW'>Helicam - (+ lăn chuột) Chỉnh độ sáng của đèn</FONT>",
        SpotlightRadius = "<FONT FACE='BARLOW'>Helicam - (+ lăn chuột) Chỉnh độ rộng của đèn</FONT>",
        Postals = "<FONT FACE='BARLOW'>Helicam - Toggle Postals</FONT>"
    },
    ChatSuggestions = {
        ToggleCamera = "Vào/Thoát camera trực thăng",
        Rappel = "Thả dây từ trực thăng"
    }
}
