...
Config.RecordTime = 3600          --Recording Time | 30 = 30 seconds | [*note: Dont increase the time too much or it may not upload to any service you are using for example - discord.]
...
Config.WatchLoc = {
    [1] = {
        coords = vector3(68.10, -399.56, 41.62), 
        rad = 0.5, 
        debug = false,
