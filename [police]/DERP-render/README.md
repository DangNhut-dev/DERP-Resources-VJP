...
[In-game streaming platform demonstration using DERP-render](https://github.com/utkuali/utk_streamer)

## Installation

- Put DERP-render in your resource folder and start it like any other resource
...
```html
<script type="module" src="nui://DERP-render/script.js"></script>
```
