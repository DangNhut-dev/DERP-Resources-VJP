...
Config.Garages = {
    ...
    ['garacardealer'] = {
        ...
        storeZone = {
            coords = vec3(-98.63, 95.30, 72.09),
            radius = 15.0,
            showText = '[E] Cất Xe'
        },
        
        npc = {
            coords = vec3(-92.73, 84.48, 70.71),
            heading = 60.21,
            model = 's_m_y_dealer_01'
        },
        ...
        spawnPoints = {
            vec4(-101.33, 99.81, 71.86, 154.95),
            vec4(-95.17, 96.77, 71.77, 154.81),
            vec4(-98.10, 84.21, 70.93, 332.24),
            vec4(-104.03, 87.71, 70.89, 331.44),
            vec4(-110.31, 90.76, 70.84, 330.91),
        },
        
        preview = {
            vehicle = vec4(-94.60, 89.84, 71.19, 63.88),
        },
    },
    ...
    ['garage_police'] = {
        ...
        storeZone = {
            coords = vec3(32.68, -369.12, 38.45),
            radius = 15.0,
            showText = '[E] Cất Xe Công Vụ'
        },
        
        npc = {
            coords = vec3(36.47, -351.89, 38.13),
            heading = 164.71,
            model = 's_m_y_cop_01'
        },
        ...
        spawnPoints = {
            vec4(26.05, -354.95, 38.73, 246.57),
            vec4(24.46, -357.98, 38.73, 245.77),
            vec4(22.80, -361.66, 38.73, 247.65),
            vec4(21.57, -365.55, 38.73, 245.80),
            vec4(19.72, -369.15, 38.73, 248.32),
            vec4(18.34, -372.35, 38.73, 245.78),
            vec4(16.72, -375.86, 38.73, 246.83),
            vec4(25.28, -389.65, 38.73, 254.95),
        },
        
        preview = {
            vehicle = vec4(41.01, -369.26, 39.13, 158.46),
        },
    },
