...
Config.Garages = {
    ...
    ['garage_police'] = {
        ...
        storeZone = {
            coords = vec3(441.46, -982.19, 25.70),
            radius = 15.0,
    ...
    ['garage_mechanic'] = {
        ...
        spawnPoints = {
            vec4(-376.43, -146.22, 38.70, 298.63),
            vec4(-379.66, -140.03, 38.70, 299.29),
            vec4(-383.14, -133.78, 38.70, 298.92),
            vec4(-386.53, -127.62, 38.70, 299.24),
        },
