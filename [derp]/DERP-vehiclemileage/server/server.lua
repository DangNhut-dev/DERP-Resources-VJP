...
lib.callback.register("DERP-vehiclemileage:server:get-mileage", function(_, plate)
  return getMileageInKmByPlate(plate)
end)

RegisterNetEvent("DERP-vehiclemileage:server:update-mileage", function(plate, mileage)
