Config = {
    ...
    Text = {
        BACK = '<FONT FACE="Akrobat-Regular">Quay Lai</FONT>',
        HIT = '<FONT FACE="Akrobat-Regular">Da</FONT>',
        BALL_IN_HAND = '<FONT FACE="Akrobat-Regular">Lay Bong</FONT>',
        BALL_IN_HAND_BACK = '<FONT FACE="Akrobat-Regular">Quay lai</FONT>',
        AIM_LEFT = '<FONT FACE="Akrobat-Regular">Sang trái</FONT>',
        AIM_RIGHT = '<FONT FACE="Akrobat-Regular">Sang phai</FONT>',
        AIM_SLOWER = '<FONT FACE="Akrobat-Regular">Giu de chinh</FONT>',

        POOL = 'Bida',
        POOL_GAME = '<FONT FACE="Akrobat-Regular">Trờ chơi Bi-a.</FONT>',
        POOL_SUBMENU = '<FONT FACE="Akrobat-Regular">Chế độ chơi.</FONT>',
        TYPE_8_BALL = '<FONT FACE="Akrobat-Regular">9 Bi.</FONT>',
        TYPE_STRAIGHT = '<FONT FACE="Akrobat-Regular">16 Bi.</FONT>',

        HINT_SETUP = '<FONT FACE="Akrobat-Regular">Cài đặt trò chơi.</FONT>',
        HINT_TAKE_CUE = '<FONT FACE="Akrobat-Regular">Lấy Gậy.</FONT>',
        HINT_RETURN_CUE = '<FONT FACE="Akrobat-Regular">Đặt lại Gậy.</FONT>',
        HINT_HINT_TAKE_CUE = '<FONT FACE="Akrobat-Regular">Để chơi bida, bạn cần phải lấy gậy bida trước.</FONT>',
        HINT_PLAY = '<FONT FACE="Akrobat-Regular">Chơi.</FONT>',

        BALL_IN_HAND_LEFT = '<FONT FACE="Akrobat-Regular">Trai</FONT>',
        BALL_IN_HAND_RIGHT = '<FONT FACE="Akrobat-Regular">Phai</FONT>',
        BALL_IN_HAND_UP = '<FONT FACE="Akrobat-Regular">Tren</FONT>',
        BALL_IN_HAND_DOWN = '<FONT FACE="Akrobat-Regular">Duoi</FONT>',
        BALL_POCKETED = '<FONT FACE="Akrobat-Regular">%s bạn đưa bóng vào lỗ </FONT>',
        BALL_IN_HAND_NOTIFY = '<FONT FACE="Akrobat-Regular">Bạn có quả bóng</FONT>',
        BALL_LABELS = {
            [-1] = 'Cue',
            [1] = '~y~Solid 1~s~',
            [2] = '~b~Solid 2~s~',
