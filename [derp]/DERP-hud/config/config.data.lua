...
Config.WeaponNames = {
  ...
  WEAPON_G26 = "Glock 26",
  WEAPON_DRACOCUSTOM = "Draco",
  WEAPON_AR15FULL = "AR-15",
  WEAPON_GLOCK29AUTO = "Glock 29",
  WEAPON_GLOCK17CUSTOM = "Glock 17-Custom",
  WEAPON_G2CTX = " Taurus G2C",
  WEAPON_SIGM17 = "Sig Sauer M17",
