...
local function openShop(mechanicId, shopIndex)
  ...
  for index, v in pairs(shopItems) do
    table.insert(options, {
      ...
      event = "DERP-mechanic:client:input-shop-purchase-qty",
...
RegisterNetEvent("DERP-mechanic:client:input-shop-purchase-qty", function(args)
  ...
  TriggerServerEvent("DERP-mechanic:server:buy-item", args.shopIndex, args.itemIndex, qty, args.mechanicId)
end)
