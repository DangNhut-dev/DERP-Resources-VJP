...
RegisterNetEvent("DERP-mechanic:client:show-lighting-controller", function()
  hasControllerItem = lib.callback.await("DERP-mechanic:server:has-item", 250, "lighting_controller")
