lib.callback.register("DERP-mechanic:server:pay-for-tune", function(source, tuneCategory, tuneOption, currentOption, plate)
...
lib.callback.register("DERP-mechanic:server:remove-tune", function(source, tuneCategory, tuneOption, plate)
  if not HasActiveTabletConnection(source, plate) then
    return false
  end
