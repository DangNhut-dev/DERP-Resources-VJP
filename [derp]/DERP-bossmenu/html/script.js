...
const formatButton = (isLast) => {
    isLast ? document.getElementById("finish_task").innerText = "Gửi đơn" : document.getElementById("finish_task").innerText = "Tiếp theo"
}
...
function GetParentResourceName() {
    try {
        ...
        return 'DERP-bossmenu'; // Default for testing in browser
    }
}
