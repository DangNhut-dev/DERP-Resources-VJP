...
function ShowNotification(text, ntype, time)
    if QBCore then
...
function EmoteChatMessage(msg, ntype, time)
...
function SimpleNotify(message, ntype, time)
