...
--             TriggerServerEvent('derp-fishing:registerBoat', NetworkGetNetworkIdFromEntity(vehicle))
--         end)
--     end
-- end
...
--     local success = lib.callback.await('derp-fishing:rentVehicle', false, index)
...
--         local success = lib.callback.await('derp-fishing:returnVehicle', false, netId)
