...
-- lib.callback.register('derp-fishing:rentVehicle', function(source, index)
...
-- RegisterNetEvent('derp-fishing:registerBoat', function(netId)
--     local source = source
...
-- lib.callback.register('derp-fishing:returnVehicle', function(source, netId)
--     local player = Framework.getPlayerFromId(source)
