...
lib.callback.register("DERP-mechanic:server:get-orders", function(source, page, limit)
...
lib.callback.register("DERP-mechanic:server:can-apply-order", function(source, orderId)
    local player = Player(source)
    local mechanicId = player.state.mechanicId
...
lib.callback.register("DERP-mechanic:server:pay-for-order-installation", function(source, modCategory, itemCount)
    local player = Player(source)
    local mechanicId = player.state.mechanicId
...
lib.callback.register("DERP-mechanic:server:mark-category-installed", function(source, orderId, category)
    local player = Player(source)
    local mechanicId = player.state.mechanicId
    if not mechanicId then return false end
...
lib.callback.register("DERP-mechanic:server:mark-order-fulfilled", function(source, orderId)
...
lib.callback.register("DERP-mechanic:server:delete-order", function(source, orderId)
    local player = Player(source)
    local mechanicId = player.state.mechanicId
    if not mechanicId then return false end
